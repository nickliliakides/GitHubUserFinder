class UI {
  ...
  showProfile(user){
      this.profile.innerHTML = `<div class="card card-body mb-3">
                                  <div class="row">
                                    <div class="col-md-3">
                                      <img src="${user.avatar_url}" alt="UserImage" class="img-fluid mb-3">
                                      <a href="${user.html_url}" target="_blank" class="btn btn-primary btn-block">View Profile</a>
                                    </div>
                                    <div class="col-md-9">
                                      <span class="badge badge-secondary">Public Repository: ${user.public_repos}</span>
    ...
    showAlert(message, className){
        ...
        // Insert alert before search field
